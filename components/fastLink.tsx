            ...
            <Panel header="快速鏈接">
                <div className="card">
                    <div className="flex flex-column md:flex-row align-items-left">
                        <p>
                        漢典網：<a className='hover:underline' href={"http://www.zdic.net/hans/"+textChar} target="_blank">{textChar}</a> | <a className='hover:underline' href={"http://www.zdic.net/zd/yy/yy/"+textChar} target="_blank">粵語</a> | <a className='hover:underline' href={"http://www.zdic.net/zd/yy/ph/"+textChar} target="_blank">平話</a><br/>
                        ...
                        重編國語辭典修訂本：<a className='hover:underline' href={"https://dict.revised.moe.edu.tw/search.jsp?md=1&word="+textChar+"#searchL"} target="_blank">{textChar}</a><br/>
                        國語辭典簡編本：<a className='hover:underline' href={"https://dict.concised.moe.edu.tw/search.jsp?md=1&word="+textChar+"&qMd=0&qCol=0"} target="_blank">{textChar}</a><br/>
                        國語小字典：<a className='hover:underline' href={"https://dict.mini.moe.edu.tw/SearchIndex/searchResult?searchType=one&dictSearchField="+textChar} target="_blank">{textChar}</a><br/>
                        ...
                        <p>
                        中國國家地名信息庫：<a className='hover:underline' href={"https://dmfw.mca.gov.cn/index.html"} target="_blank">前往</a><br/>
                        ...
                        廣西地情網：<a className='hover:underline' href={"http://www.gxdfz.org.cn/index.html"} target="_blank">前往</a><br/>
                        ...
                        廣西圖書館：<a className='hover:underline' href={"https://www.gxlib.org.cn/"} target="_blank">前往</a><br/>
